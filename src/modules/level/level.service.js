...
const LEVEL_DEFINITIONS = [
  { level: 1,  name: 'Level 1',  juz_required: 2  },
  { level: 2,  name: 'Level 2',  juz_required: 4  },
  { level: 3,  name: 'Level 3',  juz_required: 6  },
  { level: 4,  name: 'Level 4',  juz_required: 8  },
  { level: 5,  name: 'Level 5',  juz_required: 10 },
  { level: 6,  name: 'Level 6',  juz_required: 12 },
  { level: 7,  name: 'Level 7',  juz_required: 14 },
  { level: 8,  name: 'Level 8',  juz_required: 16 },
  { level: 9,  name: 'Level 9',  juz_required: 18 },
  { level: 10, name: 'Level 10', juz_required: 20 },
  { level: 11, name: 'Level 11', juz_required: 22 },
  { level: 12, name: 'Level 12', juz_required: 24 },
  { level: 13, name: 'Level 13', juz_required: 26 },
  { level: 14, name: 'Level 14', juz_required: 28 },
  { level: 15, name: 'Level 15', juz_required: 30 },
]
const MAX_LEVEL = 15
...
const getLeaderboard = async (limit) => {
  ...
  return snapshots.map((s, index) => ({
    rank: index + 1,
    user_id: s.user_id,
    display_name: s.user?.profile?.display_name ?? 'Pengguna',
    avatar_url: s.user?.profile?.avatar_url ?? null,
    current_level: s.current_level,
    level_name: LEVEL_DEFINITIONS[s.current_level - 1]?.name ?? `Level ${s.current_level}`,
    total_juz_completed: s.total_juz_completed,
